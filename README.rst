...
.. image:: https://img.shields.io/badge/license-Apache--2.0-blue.svg
    ...
    :target: https://github.com/bechtoldt/saltstack-spamassassin-formula/blob/master/LICENSE

.. image:: https://img.shields.io/badge/chat-gitter-brightgreen.svg
    :alt: Join Gitter Chat
    :target: https://gitter.im/bechtoldt/saltstack-spamassassin-formula?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
...
SaltStack Formula to set up and configure SpamAssassin, a spam filter using text analysis
...
But it’s better to `file an issue <https://github.com/bechtoldt/saltstack-spamassassin-formula/issues/new>`_ with your idea first.
